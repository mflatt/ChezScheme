...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic fixnums)] [flags primitive proc])
  ...
  (fxnegative? [sig [(fixnum) -> (boolean)]] [pred nfixnum] [flags pure cp02 safeongoodargs])
  (fxpositive? [sig [(fixnum) -> (boolean)]] [pred pfixnum] [flags pure cp02 safeongoodargs])
  (fxeven? [sig [(fixnum) -> (boolean)]] [pred fxeven] [flags pure cp02 safeongoodargs])
  (fxodd? [sig [(fixnum) -> (boolean)]] [pred fxodd] [flags pure cp02 safeongoodargs])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic flonums)] [flags primitive proc])
  ...
  (flpositive? [sig [(flonum) -> (boolean)]] [pred pflonum] [flags pure mifoldable discard safeongoodargs])
  (flnegative? [sig [(flonum) -> (boolean)]] [pred nflonum][flags pure mifoldable discard safeongoodargs])
  (flodd? [sig [(flinteger) -> (boolean)]] [pred flodd] [flags pure mifoldable discard safeongoodargs])
  (fleven? [sig [(flinteger) -> (boolean)]] [pred fleven] [flags pure mifoldable discard safeongoodargs])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
  ...
  (real-valued? [sig [(ptr) -> (boolean)]] [pred real-valued] [flags pure unrestricted mifoldable discard #;cptypes2])
  (rational-valued? [sig [(ptr) -> (boolean)]] [pred rational-valued] [flags pure unrestricted mifoldable discard cptypes2])
  (integer-valued? [sig [(ptr) -> (boolean)]] [pred integer-valued] [flags pure unrestricted mifoldable discard cptypes2])
  ...
  (positive? [sig [(real) -> (boolean)]] [pred preal] [flags pure mifoldable discard safeongoodargs ieee r5rs cptypes2])
  (negative? [sig [(real) -> (boolean)]] [pred nreal] [flags pure mifoldable discard safeongoodargs ieee r5rs cptypes2])
  (odd? [sig [(integer) -> (boolean)]] [pred odd] [flags pure mifoldable discard safeongoodargs ieee r5rs cptypes2])
  (even? [sig [(integer) -> (boolean)]] [pred even] [flags pure mifoldable discard safeongoodargs ieee r5rs cptypes2])
  ...
  (- [sig [(number number ...) -> (number)]] [flags arith-op partial-folder safeongoodargs ieee r5rs cptypes2])
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; constant parameters
  ...
  (most-negative-fixnum [sig [() -> (nfixnum)]] [flags pure unrestricted true cp02])
  (most-positive-fixnum [sig [() -> (pfixnum)]] [flags pure unrestricted true cp02])
...
(define-symbol-flags* ([libraries] [flags keyword])
  ...
  (ftype-scheme-object-pointer? [flags])
  (ftype-pointer? [flags])
  (ftype-sizeof [flags])
  (ftype-&ref [flags])
  (ftype-ref [flags])
  ...
  (make-ftype-scheme-object-pointer [flags])
  (meta [flags])
  (meta-cond [flags])
  (module [flags])
  (only [flags])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (char-indic-break-property [sig [(char) -> (symbol)]] [flags pure mifoldable discard])
  ...
  (flnonnegative? [sig [(flonum) -> (boolean)]] [pred uflonum] [flags pure mifoldable discard safeongoodargs])
  ...
  (flvector-copy! [sig [(flvector sub-length flvector sub-length sub-length) -> (void)]] [flags])
  ...
  (ftype-scheme-object-pointer-object [sig [(sub-ftype-pointer) -> (ptr)]] [flags mifoldable discard])
  (ftype-scheme-object-pointer-offset [sig [(sub-ftype-pointer) -> (exact-integer)]] [flags mifoldable discard true])
  ...
  (fxnonnegative? [sig [(fixnum) -> (boolean)]] [pred ufixnum] [flags pure cp02 safeongoodargs])
  (fxnonpositive? [sig [(fixnum) -> (boolean)]] [pred dfixnum] [flags pure cp02 safeongoodargs])
  ...
  (fxvector-copy! [sig [(fxvector sub-length fxvector sub-length sub-length) -> (void)]] [flags])
  ...
  (make-source-object [sig [(sfd uint uint) (sfd uint uint pint pint) -> (source-object)]] [flags pure true mifoldable discard])
  ...
  (nonnegative? [sig [(real) -> (boolean)]] [pred ureal] [flags pure mifoldable discard safeongoodargs cptypes2])
  (nonpositive? [sig [(real) -> (boolean)]] [pred dreal] [flags pure mifoldable discard safeongoodargs cptypes2])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($bigpositive? [sig [(ptr) -> (boolean)]] [pred pbignum] [flags pure unrestricted]) ; no mifoldable due to fixnum
  ...
  ($<= [sig [(maybe-who number number) -> (boolean)]] [flags pure discard safeongoodargs])
  ($< [sig [(maybe-who number number) -> (boolean)]] [flags pure discard safeongoodargs])
  ($= [sig [(maybe-who number number) -> (boolean)]] [flags pure discard safeongoodargs])
  ($- [sig [(maybe-who number number) -> (number)]] [flags arith-op safeongoodargs])
  ($/ [sig [(maybe-who number number) -> (number)]] [flags arith-op])
  ($* [sig [(maybe-who number number) -> (number)]] [flags arith-op safeongoodargs])
  ($+ [sig [(maybe-who number number) -> (number)]] [flags arith-op safeongoodargs])
  ...
  ($fptr-null-pointer [flags single-valued])
  ($fptr-offset-addr [flags single-valued])
  ($fptr-object-fptr-ref [flags single-valued discard])
  ...
  ($fptr-ref-double-float [sig [(ptr ptr) -> (flonum)]] [flags single-valued discard])
  ...
  ($fptr-ref-single-float [sig [(ptr ptr) -> (flonum)]] [flags single-valued discard])
  ($fptr-ref-stdbool [flags single-valued discard])
  ($fptr-ref-swap-boolean [flags single-valued discard])
  ($fptr-ref-swap-double-float [sig [(ptr ptr) -> (flonum)]] [flags single-valued discard])
  ...
  ($fptr-ref-swap-single-float [sig [(ptr ptr) -> (flonum)]] [flags single-valued discard])
  ...
  ($fptd? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ...
  ($fxx- [sig [(fixnum fixnum ...) -> (sint)]] [flags arith-op partial-folder safeongoodargs])
  ...
  ($inexactnum-imag-part [sig [($inexactnum) -> (flonum)]] [flags arith-op mifoldable discard safeongoodargs single-valued])
  ($inexactnum-real-part [sig [($inexactnum) -> (flonum)]] [flags arith-op mifoldable discard safeongoodargs single-valued])
  ...
  ($make-exactnum [sig [(exact-real exact-real) -> ($exactnum)]] [flags arith-op mifoldable discard safeongoodargs])
  ...
  ($make-object-fptr [flags single-valued pure mifoldable discard true])
  ...
  ($make-record-type [sig [(rtd maybe-rtd sub-ptr sub-list ptr ptr ptr ptr ...) -> (rtd)]] [flags pure alloc cp02])
  ...
  ($trans-ftype-scheme-object-pointer? [sig [(ptr) -> (procedure)]] [flags alloc]) ; not boolean
  ...
  ($trans-make-ftype-scheme-object-pointer [flags single-valued])

...
(define-symbol-flags* ([libraries] [flags keyword])
  ...
  (make-ftype-object-pointer [flags])
  (meta [flags])
  (meta-cond [flags])
  (module [flags])
  (only [flags])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (ftype-pointer-object [sig [(sub-ftype-pointer) -> (bytevector)]] [flags mifoldable discard true])
  (ftype-pointer-offset [sig [(sub-ftype-pointer) -> (exact-integer)]] [flags mifoldable discard true])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($fptrtd? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ...
  ($trans-ftype-object-pointer? [sig [(ptr) -> (procedure)]] [flags alloc]) ; not boolean
  ($trans-ftype-&ref [flags single-valued])
  ($trans-ftype-ref [flags single-valued])
  ($trans-ftype-set! [flags single-valued])
  ($trans-ftype-sizeof [flags single-valued])
  ($trans-make-ftype-object-pointer [flags single-valued])

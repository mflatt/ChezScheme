...
extern ptr S_bytevector2 PROTO((iptr n, IBOOL lockable));
...
extern ptr S_box2 PROTO((ptr ref, IBOOL lockable));
...
extern ptr S_lockable_bytevector PROTO((ptr bv, iptr start, iptr count, iptr copy));

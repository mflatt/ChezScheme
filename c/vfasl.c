...
# define VSPACE_END(s) ptr_add(vspaces[(s)], VSPACE_LENGTH(s))
  ...
  rtdrefs = TO_VOIDP(ptr_add(symrefs, header.symref_count * sizeof(vfoff)));
  singletonrefs = TO_VOIDP(ptr_add(rtdrefs, header.rtdref_count * sizeof(vfoff)));
  bm = TO_VOIDP(ptr_add(singletonrefs, header.singletonref_count * sizeof(vfoff)));
  bm_end = TO_VOIDP(ptr_add(table, header.table_size));

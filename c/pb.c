    ...
    case pb_call:
      {
        ...
        case pb_call_uptr_double_double_double_double_double_double:
          ...
          break;
        case pb_call_voids:
          regs[Cretval] = (uptr)((pb_voids_t)proc)();
          break;
        case pb_call_voids_uptr:
          regs[Cretval] = (uptr)((pb_voids_uptr_t)proc)(regs[Carg1]);
          break;
        default:
      ...
      break;
    case pb_lock_op_pb_lock_pb_register:
      {
        uptr *l = (uptr *)(regs[INSTR_dri_dest(instr)]
                           + regs[INSTR_dri_reg(instr)]
                           + INSTR_dri_imm(instr));
        if (*l == 0) {
          *l = 1;
          flag = 1;
      ...
      break;
    case pb_lock_op_pb_lock_incr_pb_immediate:
      {
        uptr *l = (uptr *)(regs[INSTR_dri_dest(instr)]
                           + regs[INSTR_dri_reg(instr)]
                           + INSTR_dri_imm(instr));
      ...
      break;
    case pb_lock_op_pb_lock_decr_pb_immediate:
      {
        uptr *l = (uptr *)(regs[INSTR_dri_dest(instr)]
                           + regs[INSTR_dri_reg(instr)]
                           + INSTR_dri_imm(instr));
      ...
      break;
    case pb_lock_op_pb_cas_pb_register:
      {

/* equates.h for Chez Scheme Version 10.5.0-pre-release.1 */
...
#define machine_type_a6fb 0x27
#define machine_type_a6gnu 0x1D
#define machine_type_a6hk 0x59
#define machine_type_a6ios 0x23
#define machine_type_a6le 0x25
#define machine_type_a6nb 0x2B
#define machine_type_a6nt 0x1F
...
#define machine_type_arm32ob 0x3D
#define machine_type_arm64fb 0x49
#define machine_type_arm64ios 0x45
#define machine_type_arm64le 0x47
#define machine_type_arm64nb 0x4D
...
#define machine_type_ppc32fb 0x33
#define machine_type_ppc32le 0x31
#define machine_type_ppc32nb 0x37
#define machine_type_ppc32ob 0x35
#define machine_type_ppc32osx 0x2F
#define machine_type_rv64fb 0x51
#define machine_type_rv64le 0x4F
#define machine_type_rv64nb 0x55
#define machine_type_rv64ob 0x53
#define machine_type_ta6fb 0x28
#define machine_type_ta6gnu 0x1E
#define machine_type_ta6hk 0x5A
#define machine_type_ta6ios 0x24
#define machine_type_ta6le 0x26
#define machine_type_ta6nb 0x2C
#define machine_type_ta6nt 0x20
#define machine_type_ta6ob 0x2A
#define machine_type_ta6osx 0x22
#define machine_type_ta6s2 0x2E
#define machine_type_tarm32fb 0x3C
#define machine_type_tarm32le 0x3A
#define machine_type_tarm32nb 0x40
#define machine_type_tarm32ob 0x3E
#define machine_type_tarm64fb 0x4A
#define machine_type_tarm64ios 0x46
#define machine_type_tarm64le 0x48
#define machine_type_tarm64nb 0x4E
...
#define machine_type_tla64le 0x58
...
#define machine_type_tppc32fb 0x34
#define machine_type_tppc32le 0x32
#define machine_type_tppc32nb 0x38
#define machine_type_tppc32ob 0x36
#define machine_type_tppc32osx 0x30
#define machine_type_trv64fb 0x52
#define machine_type_trv64le 0x50
#define machine_type_trv64nb 0x56
#define machine_type_trv64ob 0x54
...
#define scheme_version 0xA050001
...
#define tc_block_counter_disp 0x210
...
#define tc_current_errno_source_disp 0x208
...
#define tc_target_machine_disp 0x228
...
#define CENTRY_Scall_any_results 29
#define CENTRY_Scall_one_result 28
#define CENTRY_Sreturn 27
#define CENTRY_activate_thread 13
#define CENTRY_bignum_mask_test 31
#define CENTRY_deactivate_thread 14
#define CENTRY_flacos 40
#define CENTRY_flasin 39
#define CENTRY_flatan 41
#define CENTRY_flatan2 42
#define CENTRY_flceiling 33
#define CENTRY_flcos 37
#define CENTRY_flexp 43
#define CENTRY_flexpt 46
#define CENTRY_flfloor 32
#define CENTRY_fllog 44
#define CENTRY_fllog2 45
#define CENTRY_flround 34
#define CENTRY_flsin 36
#define CENTRY_flsqrt 47
#define CENTRY_fltan 38
#define CENTRY_fltruncate 35
#define CENTRY_foreign_entry 22
#define CENTRY_get_more_room 24
#define CENTRY_get_thread_context 1
#define CENTRY_handle_apply_overflood 2
#define CENTRY_handle_arg_error 20
#define CENTRY_handle_docall_error 3
#define CENTRY_handle_event_detour 21
#define CENTRY_handle_mvlet_error 19
...
#define CENTRY_save_errno 16
#define CENTRY_save_last_error 17
#define CENTRY_scan_remembered_set 25
#define CENTRY_segment_info 30
...
#define BLOCKCOUNTER(x) (*((ptr *)TO_VOIDP((uptr)(x)+528)))
...
#define CURRENTERRNOSOURCE(x) (*((ptr *)TO_VOIDP((uptr)(x)+520)))
...
#define SFD(x) (*((ptr *)TO_VOIDP((uptr)(x)+536)))
...
#define TARGETMACHINE(x) (*((ptr *)TO_VOIDP((uptr)(x)+552)))
...
/* pb operation jump table */
#define define_pbop_jump_table \
static const void * const jump_table[229] = { \
  && pb_nop_op_case, \
  && pb_literal_op_case, \
  && pb_mov16_pb_zero_bits_pb_shift0_op_case, \
  && pb_mov16_pb_zero_bits_pb_shift1_op_case, \
  && pb_mov16_pb_zero_bits_pb_shift2_op_case, \
  && pb_mov16_pb_zero_bits_pb_shift3_op_case, \
  && pb_mov16_pb_keep_bits_pb_shift0_op_case, \
  && pb_mov16_pb_keep_bits_pb_shift1_op_case, \
  && pb_mov16_pb_keep_bits_pb_shift2_op_case, \
  && pb_mov16_pb_keep_bits_pb_shift3_op_case, \
  && pb_mov_pb_i_i_op_case, \
  && pb_mov_pb_d_d_op_case, \
  && pb_mov_pb_i_d_op_case, \
  && pb_mov_pb_d_i_op_case, \
  && pb_mov_pb_s_d_op_case, \
  && pb_mov_pb_d_s_op_case, \
  && pb_mov_pb_d_s_d_op_case, \
  && pb_mov_pb_i_bits_d_bits_op_case, \
  && pb_mov_pb_d_bits_i_bits_op_case, \
  && pb_mov_pb_i_i_bits_d_bits_op_case, \
  && pb_mov_pb_d_lo_bits_i_bits_op_case, \
  && pb_mov_pb_d_hi_bits_i_bits_op_case, \
  && pb_bin_op_pb_no_signal_pb_add_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_add_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_sub_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_sub_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_mul_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_mul_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_div_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_div_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_subz_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_subz_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_subp_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_subp_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_and_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_and_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_ior_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_ior_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_xor_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_xor_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_lsl_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_lsl_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_lsr_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_lsr_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_asr_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_asr_pb_immediate_op_case, \
  && pb_bin_op_pb_no_signal_pb_lslo_pb_register_op_case, \
  && pb_bin_op_pb_no_signal_pb_lslo_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_add_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_add_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_sub_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_sub_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_mul_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_mul_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_div_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_div_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_subz_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_subz_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_subp_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_subp_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_and_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_and_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_ior_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_ior_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_xor_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_xor_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_lsl_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_lsl_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_lsr_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_lsr_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_asr_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_asr_pb_immediate_op_case, \
  && pb_bin_op_pb_signal_pb_lslo_pb_register_op_case, \
  && pb_bin_op_pb_signal_pb_lslo_pb_immediate_op_case, \
  && pb_cmp_op_pb_eq_pb_register_op_case, \
  && pb_cmp_op_pb_eq_pb_immediate_op_case, \
  && pb_cmp_op_pb_lt_pb_register_op_case, \
  && pb_cmp_op_pb_lt_pb_immediate_op_case, \
  && pb_cmp_op_pb_gt_pb_register_op_case, \
  && pb_cmp_op_pb_gt_pb_immediate_op_case, \
  && pb_cmp_op_pb_le_pb_register_op_case, \
  && pb_cmp_op_pb_le_pb_immediate_op_case, \
  && pb_cmp_op_pb_ge_pb_register_op_case, \
  && pb_cmp_op_pb_ge_pb_immediate_op_case, \
  && pb_cmp_op_pb_ab_pb_register_op_case, \
  && pb_cmp_op_pb_ab_pb_immediate_op_case, \
  && pb_cmp_op_pb_bl_pb_register_op_case, \
  && pb_cmp_op_pb_bl_pb_immediate_op_case, \
  && pb_cmp_op_pb_cs_pb_register_op_case, \
  && pb_cmp_op_pb_cs_pb_immediate_op_case, \
  && pb_cmp_op_pb_cc_pb_register_op_case, \
  && pb_cmp_op_pb_cc_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_add_pb_register_op_case, \
  && pb_fp_bin_op_pb_add_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_sub_pb_register_op_case, \
  && pb_fp_bin_op_pb_sub_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_mul_pb_register_op_case, \
  && pb_fp_bin_op_pb_mul_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_div_pb_register_op_case, \
  && pb_fp_bin_op_pb_div_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_subz_pb_register_op_case, \
  && pb_fp_bin_op_pb_subz_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_subp_pb_register_op_case, \
  && pb_fp_bin_op_pb_subp_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_and_pb_register_op_case, \
  && pb_fp_bin_op_pb_and_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_ior_pb_register_op_case, \
  && pb_fp_bin_op_pb_ior_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_xor_pb_register_op_case, \
  && pb_fp_bin_op_pb_xor_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_lsl_pb_register_op_case, \
  && pb_fp_bin_op_pb_lsl_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_lsr_pb_register_op_case, \
  && pb_fp_bin_op_pb_lsr_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_asr_pb_register_op_case, \
  && pb_fp_bin_op_pb_asr_pb_immediate_op_case, \
  && pb_fp_bin_op_pb_lslo_pb_register_op_case, \
  && pb_fp_bin_op_pb_lslo_pb_immediate_op_case, \
  && pb_un_op_pb_not_pb_register_op_case, \
  && pb_un_op_pb_not_pb_immediate_op_case, \
  && pb_un_op_pb_sqrt_pb_register_op_case, \
  && pb_un_op_pb_sqrt_pb_immediate_op_case, \
  && pb_fp_un_op_pb_not_pb_register_op_case, \
  && pb_fp_un_op_pb_not_pb_immediate_op_case, \
  && pb_fp_un_op_pb_sqrt_pb_register_op_case, \
  && pb_fp_un_op_pb_sqrt_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_eq_pb_register_op_case, \
  && pb_fp_cmp_op_pb_eq_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_lt_pb_register_op_case, \
  && pb_fp_cmp_op_pb_lt_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_gt_pb_register_op_case, \
  && pb_fp_cmp_op_pb_gt_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_le_pb_register_op_case, \
  && pb_fp_cmp_op_pb_le_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_ge_pb_register_op_case, \
  && pb_fp_cmp_op_pb_ge_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_ab_pb_register_op_case, \
  && pb_fp_cmp_op_pb_ab_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_bl_pb_register_op_case, \
  && pb_fp_cmp_op_pb_bl_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_cs_pb_register_op_case, \
  && pb_fp_cmp_op_pb_cs_pb_immediate_op_case, \
  && pb_fp_cmp_op_pb_cc_pb_register_op_case, \
  && pb_fp_cmp_op_pb_cc_pb_immediate_op_case, \
  && pb_rev_op_pb_int8_pb_register_op_case, \
  && pb_rev_op_pb_int8_pb_immediate_op_case, \
  && pb_rev_op_pb_uint8_pb_register_op_case, \
  && pb_rev_op_pb_uint8_pb_immediate_op_case, \
  && pb_rev_op_pb_int16_pb_register_op_case, \
  && pb_rev_op_pb_int16_pb_immediate_op_case, \
  && pb_rev_op_pb_uint16_pb_register_op_case, \
  && pb_rev_op_pb_uint16_pb_immediate_op_case, \
  && pb_rev_op_pb_int32_pb_register_op_case, \
  && pb_rev_op_pb_int32_pb_immediate_op_case, \
  && pb_rev_op_pb_uint32_pb_register_op_case, \
  && pb_rev_op_pb_uint32_pb_immediate_op_case, \
  && pb_rev_op_pb_int64_pb_register_op_case, \
  && pb_rev_op_pb_int64_pb_immediate_op_case, \
  && pb_rev_op_pb_uint64_pb_register_op_case, \
  && pb_rev_op_pb_uint64_pb_immediate_op_case, \
  && pb_rev_op_pb_single_pb_register_op_case, \
  && pb_rev_op_pb_single_pb_immediate_op_case, \
  && pb_rev_op_pb_double_pb_register_op_case, \
  && pb_rev_op_pb_double_pb_immediate_op_case, \
  && pb_ld_op_pb_int8_pb_register_op_case, \
  && pb_ld_op_pb_int8_pb_immediate_op_case, \
  && pb_ld_op_pb_uint8_pb_register_op_case, \
  && pb_ld_op_pb_uint8_pb_immediate_op_case, \
  && pb_ld_op_pb_int16_pb_register_op_case, \
  && pb_ld_op_pb_int16_pb_immediate_op_case, \
  && pb_ld_op_pb_uint16_pb_register_op_case, \
  && pb_ld_op_pb_uint16_pb_immediate_op_case, \
  && pb_ld_op_pb_int32_pb_register_op_case, \
  && pb_ld_op_pb_int32_pb_immediate_op_case, \
  && pb_ld_op_pb_uint32_pb_register_op_case, \
  && pb_ld_op_pb_uint32_pb_immediate_op_case, \
  && pb_ld_op_pb_int64_pb_register_op_case, \
  && pb_ld_op_pb_int64_pb_immediate_op_case, \
  && pb_ld_op_pb_uint64_pb_register_op_case, \
  && pb_ld_op_pb_uint64_pb_immediate_op_case, \
  && pb_ld_op_pb_single_pb_register_op_case, \
  && pb_ld_op_pb_single_pb_immediate_op_case, \
  && pb_ld_op_pb_double_pb_register_op_case, \
  && pb_ld_op_pb_double_pb_immediate_op_case, \
  && pb_st_op_pb_int8_pb_register_op_case, \
  && pb_st_op_pb_int8_pb_immediate_op_case, \
  && pb_st_op_pb_uint8_pb_register_op_case, \
  && pb_st_op_pb_uint8_pb_immediate_op_case, \
  && pb_st_op_pb_int16_pb_register_op_case, \
  && pb_st_op_pb_int16_pb_immediate_op_case, \
  && pb_st_op_pb_uint16_pb_register_op_case, \
  && pb_st_op_pb_uint16_pb_immediate_op_case, \
  && pb_st_op_pb_int32_pb_register_op_case, \
  && pb_st_op_pb_int32_pb_immediate_op_case, \
  && pb_st_op_pb_uint32_pb_register_op_case, \
  && pb_st_op_pb_uint32_pb_immediate_op_case, \
  && pb_st_op_pb_int64_pb_register_op_case, \
  && pb_st_op_pb_int64_pb_immediate_op_case, \
  && pb_st_op_pb_uint64_pb_register_op_case, \
  && pb_st_op_pb_uint64_pb_immediate_op_case, \
  && pb_st_op_pb_single_pb_register_op_case, \
  && pb_st_op_pb_single_pb_immediate_op_case, \
  && pb_st_op_pb_double_pb_register_op_case, \
  && pb_st_op_pb_double_pb_immediate_op_case, \
  && pb_b_op_pb_fals_pb_register_op_case, \
  && pb_b_op_pb_fals_pb_immediate_op_case, \
  && pb_b_op_pb_true_pb_register_op_case, \
  && pb_b_op_pb_true_pb_immediate_op_case, \
  && pb_b_op_pb_always_pb_register_op_case, \
  && pb_b_op_pb_always_pb_immediate_op_case, \
  && pb_bs_op_pb_register_op_case, \
  && pb_bs_op_pb_immediate_op_case, \
  && pb_call_op_case, \
  && pb_return_op_case, \
  && pb_interp_op_case, \
  && pb_adr_op_case, \
  && pb_inc_pb_register_op_case, \
  && pb_inc_pb_immediate_op_case, \
  && pb_lock_op_case, \
  && pb_cas_op_case, \
  && pb_call_arena_in_op_case, \
  && pb_call_arena_out_op_case, \
  && pb_fp_call_arena_in_op_case, \
  && pb_fp_call_arena_out_op_case, \
  && pb_stack_call_op_case, \
  && pb_fence_pb_fence_store_store_op_case, \
  && pb_fence_pb_fence_acquire_op_case, \
  && pb_fence_pb_fence_release_op_case, \
  && pb_chunk_op_case, \
}
